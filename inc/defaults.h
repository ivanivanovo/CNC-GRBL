...
#include "config.h"
  ...
  #define defaults_h
    ...
    #define DEFAULT_X_MAX_RATE 3500.0f // mm/min
    #define DEFAULT_Y_MAX_RATE 3500.0f // mm/min
    #define DEFAULT_Z_MAX_RATE 3500.0f // mm/min
    #if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
    ...
    #define DEFAULT_X_ACCELERATION (300.0f*60*60) //mm/min^2  // 300mm/sec^2
    #define DEFAULT_Y_ACCELERATION (300.0f*60*60) //mm/min^2  // 300mm/sec^2
    #define DEFAULT_Z_ACCELERATION (300.0f*60*60) //mm/min^2  // 300mm/sec^2
    #if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
    ...
    #define DEFAULT_SPINDLE_RPM_MAX 10000.0f // rpm
    #define DEFAULT_SPINDLE_RPM_MIN 0.0f // rpm
    #define DEFAULT_STEP_PULSE_MICROSECONDS 10 //usec
    #define DEFAULT_STEPPING_INVERT_MASK 0
    #define DEFAULT_DIRECTION_INVERT_MASK 1 // X only
    #define DEFAULT_STEPPER_IDLE_LOCK_TIME 0 // msec (0-254, 255 keeps steppers enabled)
    #define DEFAULT_STATUS_REPORT_MASK 1 // MPos enabled
    #define DEFAULT_JUNCTION_DEVIATION 0.01f // mm
    #define DEFAULT_ARC_TOLERANCE 0.002f // mm
